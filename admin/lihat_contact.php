...
<head>
	...
	<title>Lihat Contact Admin</title>
...
<body>
  ...
  <div class="row no-gutters">
    ...
    <div class="col-md-9 bg-white p-5 pt-5">
      <p class="fs-4"><i class="fas fa-list-ul" style="margin-right: 10px;"></i>Lihat Contact</p>
            ...
            <?php
              ...
              while($d = mysqli_fetch_array($data)){
                ...
                <tr>
                    ...
                    <td><?php echo $d['github'];?></td>
                    <td><?php echo $d['facebook'];?></td>
                    <td><?php echo $d['instagram'];?></td>
                    <td>
                      <a href="tampil_ubah_contact.php?id_contact=<?php echo $d['id_contact']; ?>" class="btn btn-primary">Edit</a>
                      <!-- <a href="hapus_contact.php?id_contact=<?php echo $d['id_contact']; ?>" class="btn btn-danger">Hapus</a> -->
                    </td>
                </tr>
                <?php
              } ?>
