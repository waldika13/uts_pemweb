...
<body>
  ...
  <div class="row no-gutters">
    ...
    <div class="col-md-9 bg-white p-5 pt-5">
      <p class="fs-4"><i class="fas fa-address-card" style="margin-right: 10px;"></i>Edit Testimoni</p>
      
      <div class="row">
        <form action="proses_ubah_testimoni.php" method="POST" enctype="multipart/form-data">
          <input type="hidden" name="id_testimoni" value="<?php echo $id_testimoni; ?>">
          <div class="form-group">
            <label for="exampleInputEmail1" class="form-label">Nama Testimoni</label>
            <input type="text" name="namaTestimoni" value="<?php echo $namaTestimoni; ?>" class="form-control mb-3" placeholder="Masukan Nama Lengkap Testimoni">
          </div>
          <div class="form-group">
          ...
          <a href="lihat_testimoni.php" class="btn btn-primary">Kembali</a>
