...
<body>
  ...
  <div class="row no-gutters">
    ...
    <div class="col-md-9 bg-white p-5 pt-5">
      <p class="fs-4"><i class="fas fa-hand-holding-heart" style="margin-right: 10px;"></i>Edit Education</p>
      
      <div class="row">
        <form action="proses_ubah_education.php" method="POST" enctype="multipart/form-data">
          <input type="hidden" name="id_education" value="<?php echo $id_education; ?>" >
          <div class="form-group">
            <label for="exampleInputEmail1" class="form-label">Nama Sekolah</label>
            <input type="text" name="nama_sekolah" value="<?php echo $kampus; ?>" class="form-control mb-3" placeholder="Masukan Nama Sekolah">
          </div>
          <div class="form-group">
            <label for="exampleInputEmail1" class="form-label">Program Studi</label>
            <input type="text" name="programStudi" value="<?php echo $programStudi; ?>" class="form-control mb-3" placeholder="Masukan Program Studi">
          </div>
          <div class="form-group">
            <label for="exampleInputEmail1" class="form-label">Awal Sekolah</label>
            <input type="text" name="awalSekolah" value="<?php echo $awalSekolah; ?>" class="form-control mb-3" placeholder="Masukan Tahun Awal Masuk Sekolah">
          </div>
          <div class="form-group">
            <label for="exampleInputEmail1" class="form-label">Akhir Sekolah</label>
            <input type="text" name="akhirSekolah" value="<?php echo $akhirSekolah; ?>" class="form-control mb-3" placeholder="Masukan Tahun Akhir Masuk Sekolah">
          </div>
          ...
          <a href="lihat_education.php" class="btn btn-primary">Kembali</a>
