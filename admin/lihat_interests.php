...
<head>
	...
	<title>Lihat Interests Admin</title>
...
<body>
  ...
  <div class="row no-gutters">
    ...
    <div class="col-md-9 bg-white p-5 pt-5">
      <p class="fs-4"><i class="fas fa-list-ul" style="margin-right: 10px;"></i>Lihat Interests</p>
            ...
            <?php
              ...
              while($d = mysqli_fetch_array($data)){
                ...
                <tr>
                    ...
                    <td>
                      <a href="tampil_ubah_interests.php?id_interests=<?php echo $d['id_interests']; ?>" class="btn btn-primary">Edit</a>
