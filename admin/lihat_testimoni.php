...
<head>
	...
	<title>Lihat Testimoni Admin</title>
...
<body>
  ...
  <div class="row no-gutters">
    ...
    <div class="col-md-9 bg-white p-5 pt-5">
      <p class="fs-4"><i class="fas fa-list-ul" style="margin-right: 10px;"></i>Lihat Testimoni</p>

      <a href="tambah_testimoni.php?id_testimoni=<?php echo $d['id_testimoni']; ?>" class="btn btn-success">Tambah</a>
          ...
          <table class="table table-striped">
            ...
            <?php
              ...
              while($d = mysqli_fetch_array($data)){
                ...
                <tr>
                    <td><?php echo $no++;?></td>
                    <td><?php echo $d['namaTestimoni'];?></td>
                    <td><?php echo $d['deskripsi'];?></td>
                    <td>
                      <a href="tampil_ubah_testimoni.php?id_testimoni=<?php echo $d['id_testimoni']; ?>" class="btn btn-primary">Edit</a>
                      <a href="hapus_testimoni.php?id_testimoni=<?php echo $d['id_testimoni']; ?>" class="btn btn-danger">Hapus</a>
                    </td>
                </tr>
                <?php
              } ?>
