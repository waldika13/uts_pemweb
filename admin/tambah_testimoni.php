...
<body>
  ...
  <div class="row no-gutters">
    ...
    <div class="col-md-9 bg-white p-5 pt-5">
      <p class="fs-4"><i class="fas fa-thumbs-up" style="margin-right: 10px;"></i>Tambah Testimoni</p>
      ...
      <div class="row">
        <form action="proses_tambah_testimoni.php" method="POST" enctype="multipart/form-data">
          <div class="form-group">
            ...
            <input type="text" name="namaTestimoni" class="form-control mb-3" placeholder="Masukan Nama Lengkap Testimoni">
          </div>
          <div class="form-group">
            <label for="exampleInputEmail1" class="form-label">Deskripsi</label>
            <textarea class="form-control mb-3" name="deskripsi" placeholder="Masukan Deskripsi"></textarea>
          </div>
